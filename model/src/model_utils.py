...
from src.backbones import base_model, utae, uncrtaints, promptir, multisar, multisarv2, multisarv3
...
def get_generator(config):
    ...
    elif 'multisar' == config.model:
        model = multisar.MultiSAR(
                input_dim=S1_BANDS*config.use_sar+S2_BANDS,
                encoder_widths=config.encoder_widths,
                decoder_widths=config.decoder_widths, 
                out_conv=config.out_conv,
    ...
    elif 'multisarv2' == config.model:
        model = multisarv2.MultiSARv2(
                input_dim=S1_BANDS*config.use_sar+S2_BANDS,
                encoder_widths=config.encoder_widths,
                decoder_widths=config.decoder_widths,
                out_conv=config.out_conv,
