...
def create_parser(mode='train'):
    ...
    if mode=='train':
        ...
        parser.add_argument("--optical_path", default="", type=str)
        parser.add_argument("--sar_path", default="", type=str)
    elif mode=='infer':
        print("infer")
        parser.add_argument("--optical_path", default="", type=str)
        parser.add_argument("--sar_path", default="", type=str)
    ...
    parser.add_argument("--display_step", default=1000, type=int, help="Interval in batches between display of training metrics",)
